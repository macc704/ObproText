 ...
 * @version 1.0
 */
public class ScoreManagerOO3 {

	public static void main(String[] args) {
		ScoreManagerOO3 scoreManager = new ScoreManagerOO3();
		scoreManager.main();
	}
	...
	//成績データ
	private ObjectList scoreList;//配列リスト
	//private ObjectLinkedList scoreList;//連結リスト
	...
	private void initializeData() {
		scoreList = new ObjectList();//配列リスト
		//scoreList = new ObjectLinkedList();//連結リスト
	}
