...
public class ScoreManager1 {
	...
	void deleteScore() {
		// 削除対象の入力を受け取る
		System.out.println("削除する成績の番号を入力してください");
	...
	void searchScore() {
		// 検索対象の入力を受け取る
		System.out.println("検索する成績の番号を入力してください");
		...
		// 検索結果を出力する
		System.out.println(scores.get(searchIndex) + "点です");
	}
	...
	void showScoreList() {
		...
		for (int i = 0; i < scores.size(); i++) {
			System.out.println("成績[" + i + "]" + scores.get(i) + "点");
		}
